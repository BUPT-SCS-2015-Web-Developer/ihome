...
<div class="formBox container white box">
  ...
  <div class="input-field col s12">
    ...
    <label for="quesSubject">问题标题*</label>
  </div>
  <div class="input-field col s12">
    <textarea placeholder="请输入问题详情" id="quesContent" class="materialize-textarea" data-length="500" length="500"
              maxlength="500"></textarea>
    <label for="quesContent">问题详情</label>
  </div>
  <p>
