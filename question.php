...
$type = $res['data']['type'] == 1 ? 1 : 2;
$type2 = $res['data']['type'] == 1 ? "生活服务" : "问题反馈";
...
<head>
  ...
  <title><?php echo $res['data']['subject']; ?> - <?php echo $type2; ?> 北邮易班</title>
...
<div class="quesBox container white box">
  ...
  <p id="infoBox"><span id="quesUser"><?php echo $type2; ?>
      &nbsp;&nbsp;<?php echo $res['data']['create_user_name']; ?></span>&nbsp;&nbsp;于&nbsp;&nbsp;<span id="quesTime"><?php
          $a = explode('.', $res['data']['create_time']);
          echo $a[0];
          ?></span></p>
  <hr>
    <?php if ($res['data']['type'] == 2) {
  ...
  <button class="btn waves-effect waves-light left" id="praiseBtn"><span
        class="btnToggle"><?php echo $praiseToggle; ?></span>赞&nbsp;<span
        id="praiseNum"><?php echo $res['data']['hot']; ?></span>
    <i class="material-icons right">thumb_up</i>
  </button>
  &nbsp;
  <button class="btn waves-effect waves-light blue-dar" id="followBtn"><span
        class="btnToggle"><?php echo $followToggle; ?></span>关注
...
<div class="newBox container white box">
  ...
  <p id="anonymousBox">
    ...
    <label class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="若不匿名，评论处将显示您的易班昵称"
           for="anonymous">匿名</label>
  </p>
</div>
