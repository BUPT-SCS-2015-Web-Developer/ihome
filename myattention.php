...
<?php
  ...
  for ($i=0;$i<$num_result;$i++) {
    $row = mysqli_fetch_row($result);
        ?> 
        <tr class="hoverable" id="minus_guanzhu_<?php echo $i?>">
          <td><a href="" class="">（最后替换成问题本身）我关注的问题<?php echo $i?></a></td>
          <td><a onclick="minus_guanzhu(<?php echo $i?>)"><img src="assets/img/icon_minus_alt.png" class="minus"></a></td>
        </tr>
<?php   
        }
?> 
